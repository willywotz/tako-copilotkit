...
const GenerateDataQuestions = tool(() => {}, {
  ...
  description: "Generate 3-5 data-focused questions to search Tako's knowledge base for relevant charts and visualizations.",
  ...
  const response = await model.bindTools!(
    ...
    [
      new SystemMessage(
        ...
        You have access to Tako's knowledge base of charts and visualizations through MCP tools.
        When starting research, use GenerateDataQuestions to create 3-5 data-focused questions.
        This will trigger a search of both Tako charts (tako_knowledge_search) and web resources (Tavily).
        Tako charts will appear as resources with iframe embeds you can reference in your report.
